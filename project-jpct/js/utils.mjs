...
export async function loadHeaderFooter() {
  const headerTemplate = await loadTemplate("/wdd330/project-jpct/partials/header.html");
  const headerElement = document.querySelector("#main-header");
  const footerTemplate = await loadTemplate("/wdd330/project-jpct/partials/footer.html");
